...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // bluecoin: 1 days
static const int64 nTargetSpacing = 45; // bluecoin: 45 second
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal bluecoin miner
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x3fc0fbedcdd91c93340dba6ca96ac5826d17c294f4beb4f4a3fea5b6565be5a5");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Bitcoin is legal tender in Croatia";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1386913377; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 0;

        if (fTestNet)
        {
            block.nTime    = 1386913377;
            block.nNonce   = 440824;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x543be11c25264ab726ca881cc5ba83947ffa8fdf654ad5e48bf3314398da5d1b"));
